...
function home() {
 ...
 <section class="home-section"><div class="section-label"><h2>代表项目</h2></div><div class="section-content"><div class="compact-repos">${config.repositories.slice(0,1).map(projectRow).join('')}</div><a class="more-link" href="${url('projects')}">查看全部 ${config.repositories.length} 个项目 <span aria-hidden="true">→</span></a></div></section>
